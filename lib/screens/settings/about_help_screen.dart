          ...
          children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: ThemeConfig.accentColor(context).withValues(alpha: 0.1),
                      ),
                      child: Icon(
                        Icons.shield,
                        size: 50,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTeamRow('Developers:', 'Hari Krishna , Sanmuganadan ', context),
                  const SizedBox(height: 12),
                  _buildTeamRow('Institution:', 'Tech Mumbai University', context),
                  const SizedBox(height: 12),
                  _buildTeamRow('Project Guide:', 'Dipti Parmar', context),
                  const SizedBox(height: 12),
                  _buildTeamRow('Year:', '2025-2026', context),
                ],
              ),
            ),
            const SizedBox(height: 24),
            ...
            Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: ThemeConfig.infoColor(context).withValues(alpha: 0.3),
                  width: 1,
                ),
              ),
